...
print_modname() {
	ui_print "************************************"
	ui_print "sqlite3 Universal Installer"
...
on_install() {
	...
	unzip -o "$ZIPFILE" 'sqlite3-*' -d $TMPDIR >&2

		# check for required files
	ui_print "Checking for existing sqlite3 binary...."
	if [ -f /data/data/com.termux/files/usr/bin/sqlite3 ] ; then
		...
		ui_print "SQLite3 binary not found..."
		ui_print " "
		ui_print "Determining architecture...";
